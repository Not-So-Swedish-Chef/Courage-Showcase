...
export class AdminUserService {
  ...
  private readonly _users$ = new BehaviorSubject<User[]>([
    { id: 1, firstName: 'Alice', lastName: 'Smith', email: 'alice@mail.com', userType: 1 },
    { id: 2, firstName: 'Bob',   lastName: 'Chen',  email: 'bob@mail.com',   userType: 2 },
    { id: 3, firstName: 'Eve',   lastName: 'Brown', email: 'eve@mail.com',   userType: 0 },
  ]);
